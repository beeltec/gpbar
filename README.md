...
See [live validation](docs/manual-validation.md) before using it for work.

- [Build and package](docs/build.md)
- [Protocol and process boundaries](docs/backend-protocol.md)
- [Runtime security and recovery](docs/security.md)
- [Removal](docs/removal.md)
- [Source provenance](docs/upstream.md)
